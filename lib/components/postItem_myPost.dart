...
class PostItemMyPost extends StatefulWidget {
  ...
  const PostItemMyPost(
      ...
      : super(key: key);
  @override
  State<StatefulWidget> createState() => _PostItemMyPost();
}

class _PostItemMyPost extends State<PostItemMyPost> {
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(widget.data['posterName'].toString(),
